    ...
    <CRMLayout title="Cotizaciones" onRefresh={loadData}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-4">
          ...
          <div className="text-2xl font-bold text-gray-700">{estadosCounts.borrador}</div>
        </div>
        <div className="bg-white rounded-lg shadow-md p-4">
          <div className="text-sm text-slate-600">Enviadas</div>
          <div className="text-2xl font-bold text-blue-600">{estadosCounts.enviada}</div>
        </div>
        <div className="bg-white rounded-lg shadow-md p-4">
          <div className="text-sm text-slate-600">Aceptadas</div>
          <div className="text-2xl font-bold text-green-600">{estadosCounts.aceptada}</div>
        </div>
        <div className="bg-white rounded-lg shadow-md p-4">
      ...
      {loading ? (
        <div className="text-center py-12">
          ...
          <p className="text-white mt-4">Cargando cotizaciones...</p>
        </div>
      ) : filteredCotizaciones.length === 0 ? (
        <div className="bg-white rounded-lg shadow-md p-12 text-center">
          <p className="text-slate-600 text-lg">No hay cotizaciones que mostrar</p>
          <Link href="/crm/cotizaciones/nueva">
