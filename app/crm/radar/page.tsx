    ...
    <CRMLayout>
      <div className="p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Radar — Suscriptores</h1>
            <p className="text-sm text-gray-500 mt-1">Gestiona suscriptores del producto Radar de inteligencia competitiva</p>
          </div>
