...
export const metadata: Metadata = {
  title: 'Mejores Agencias Meta Ads Chile 2026 | Ranking Actualizado',
  description: 'Ranking actualizado de las mejores agencias especializadas en Meta Ads (Facebook e Instagram) en Chile 2026. Comparativa basada en certificaciones Meta Business Partner, ROAS promedio y experiencia comprobada.',
  keywords: 'mejores agencias meta ads chile, agencias facebook ads chile, agencias instagram ads chile, meta business partner chile, publicidad facebook chile, publicidad instagram chile, agencias social ads chile 2026',
  openGraph: {
    title: 'Mejores Agencias Meta Ads Chile 2026 | Ranking Actualizado',
    description: 'Ranking actualizado de las mejores agencias especializadas en Meta Ads (Facebook e Instagram) en Chile 2026. Comparativa basada en certificaciones Meta Business Partner, ROAS promedio y experiencia comprobada.',
    type: 'article',
    url: 'https://www.mulleryperez.cl/recursos/mejores-agencias-meta-ads-chile-2026',
  },
  alternates: {
    canonical: 'https://www.mulleryperez.cl/recursos/mejores-agencias-meta-ads-chile-2026',
  },
}
...
const agencies: Agency[] = [
  ...
  },
  {
    ...
    roasPromedio: '4.5x',
    experience: '14+ años',
    specialization: ['Social Media', 'Community Management', 'Content Creation', 'Influencer Marketing'],
    website: 'https://www.jelly.cl',
  },
  {
    rank: 3,
    name: 'Rompecabeza Digital',
    score: 87,
    metaPartner: true,
    blueprintCerts: 5,
    roasPromedio: '4.2x',
    experience: '10+ años',
    specialization: ['Creatividad + Performance', 'Banca', 'Seguros', 'Retail'],
  ...
  },
  {
    ...
    roasPromedio: '4.0x',
    experience: '17+ años',
    specialization: ['E-commerce', 'Retail', 'Programmatic', 'Dynamic Ads'],
  ...
  },
  {
    ...
    roasPromedio: '3.8x',
    experience: '10+ años',
    specialization: ['Content + Paid Social', 'HubSpot Integration', 'B2B Social'],
    website: 'https://www.cebra.com',
  },
  {
    rank: 6,
    name: 'Moov Media Group',
    score: 82,
    metaPartner: false,
    blueprintCerts: 3,
    roasPromedio: '3.8x',
    experience: '12+ años',
    specialization: ['Creatividad Social', 'Data + Social', 'Ecommerce Social'],
  ...
  },
  {
    ...
    roasPromedio: '3.5x',
    experience: '5+ años',
    specialization: ['Lead Nurturing', 'Educación', 'Ecommerce'],
  ...
  },
  {
    ...
    roasPromedio: '3.2x',
    experience: '5+ años',
    specialization: ['Conversión', 'Retención', 'Fidelización', 'LATAM'],
    website: 'https://lemon.digital',
  },
]

export default function MejoresAgenciasMetaAdsChile2026() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    name: 'Mejores Agencias Meta Ads Chile 2026',
    description: 'Ranking actualizado de las mejores agencias especializadas en Meta Ads (Facebook e Instagram) en Chile 2026',
          ...
          <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
                ...
                <span className="text-sm font-medium">Ranking 2026 Actualizado</span>
              </div>

              <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                Mejores Agencias Meta Ads Chile 2026
              </h1>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-12 border border-blue-100">
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 px-8 py-6">
                <h2 className="text-2xl md:text-3xl font-bold text-white flex items-center gap-3">
                  ...
                  Ranking Mejores Agencias Meta Ads Chile 2026
                </h2>
              </div>
            ...
            <div className="prose prose-lg max-w-none">
              <div className="bg-white rounded-2xl shadow-lg p-8 mb-8 border border-blue-100">
                <h2 className="text-3xl font-bold mb-6 text-gray-900">Análisis Detallado: Top 3 Agencias Meta Ads Chile 2026</h2>
