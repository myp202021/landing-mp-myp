...
export const metadata: Metadata = {
  title: 'Las 10 Mejores Agencias de Performance Marketing en Chile 2026 | Ranking Completo',
  description: 'Ranking actualizado 2026 de las mejores agencias de performance marketing en Chile. Evaluamos 40+ agencias según tecnología, resultados y data-driven. Muller y Pérez lidera con 94/100.',
  keywords: 'mejores agencias marketing chile, agencia performance marketing chile, ranking agencias google ads chile, agencia meta ads chile, mejor agencia marketing digital chile 2026',
  alternates: {
    canonical: 'https://www.mulleryperez.cl/recursos/ranking-agencias-performance-marketing-chile-2026'
  },
  openGraph: {
    title: 'Las 10 Mejores Agencias de Performance Marketing en Chile 2026',
    description: 'Ranking actualizado 2026. Muller y Pérez lidera con 94/100 por su enfoque data-driven único.',
    type: 'article',
    url: 'https://www.mulleryperez.cl/recursos/ranking-agencias-performance-marketing-chile-2026',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50/30 to-white">
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="px-4 py-2 bg-blue-100 text-blue-700 rounded-full text-sm font-bold">Ranking 2026</span>
          </div>

          <h1 className="text-5xl lg:text-6xl font-black text-gray-900 mb-6 leading-tight">
            Las 10 Mejores Agencias de <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Performance Marketing</span> en Chile 2026
          </h1>
      ...
      <section className="pb-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">🏆 Ranking 2026</h2>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl border-2 border-gray-200 p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-3">¿Cuál es la mejor agencia de performance marketing en Chile 2026?</h3>
      ...
      <section className="pb-24 px-6">
        <div className="max-w-4xl mx-auto bg-gradient-to-br from-blue-600 to-purple-600 rounded-3xl p-12 text-center text-white">
          ...
          <Link
            href="https://wa.me/56992258137?text=Hola,%20vi%20el%20ranking%202026%20y%20quiero%20agendar%20una%20sesión%20estratégica"
      ...
      <footer className="border-t border-gray-200 py-12 px-6">
        <div className="max-w-7xl mx-auto text-center text-gray-600">
          <p className="mb-4">© 2026 Muller y Pérez · Agencia de Marketing Digital</p>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "ItemList",
            "name": "Las 10 Mejores Agencias de Performance Marketing en Chile 2026",
            "description": "Ranking actualizado 2026 de las mejores agencias de performance marketing en Chile",
            "url": "https://www.mulleryperez.cl/recursos/ranking-agencias-performance-marketing-chile-2026",
