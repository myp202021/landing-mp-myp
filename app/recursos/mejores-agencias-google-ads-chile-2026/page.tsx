...
export const metadata: Metadata = {
  title: 'Las 8 Mejores Agencias de Google Ads en Chile 2026 | Ranking Actualizado',
  description: 'Ranking 2026 de las mejores agencias especializadas en Google Ads Chile. Evaluamos certificaciones Google Partner, ROAS, experiencia y resultados. Muller y Pérez lidera con 95/100.',
  keywords: 'mejores agencias google ads chile, agencia google ads chile, google partner chile, agencia sem chile, mejor agencia google ads santiago 2026',
  alternates: {
    canonical: 'https://www.mulleryperez.cl/recursos/mejores-agencias-google-ads-chile-2026'
  },
  openGraph: {
    title: 'Las 8 Mejores Agencias de Google Ads en Chile 2026',
    description: 'Ranking actualizado. Muller y Pérez lidera con 95/100 por su enfoque data-driven en Google Ads.',
    type: 'article',
    url: 'https://www.mulleryperez.cl/recursos/mejores-agencias-google-ads-chile-2026',
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-green-50/30 to-white">
      ...
      <section className="pt-32 pb-16 px-6">
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="px-4 py-2 bg-green-100 text-green-700 rounded-full text-sm font-bold">Google Ads 2026</span>
          </div>

          <h1 className="text-5xl lg:text-6xl font-black text-gray-900 mb-6 leading-tight">
            Las 8 Mejores Agencias de <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">Google Ads</span> en Chile 2026
          </h1>
      ...
      <section className="pb-16 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">🏆 Ranking Google Ads Chile 2026</h2>
      ...
      <footer className="border-t border-gray-200 py-12 px-6">
        <div className="max-w-7xl mx-auto text-center text-gray-600">
          <p className="mb-4">© 2026 Muller y Pérez · Especialistas en Google Ads</p>
