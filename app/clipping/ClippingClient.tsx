          ...
          {enviado ? (
            ...
            <form onSubmit={handleTrial} className="space-y-4">
              <div>
                ...
                <input type="email" required value={trialEmail} onChange={function(e) { setTrialEmail(e.target.value) }} placeholder="tu@empresa.com" className="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
              </div>
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-1">Cuenta a monitorear 1</label>
                <input type="text" required value={url1} onChange={function(e) { setUrl1(e.target.value) }} placeholder="https://www.instagram.com/competidor/" className="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
              </div>
              <div>
                ...
                <input type="text" value={url2} onChange={function(e) { setUrl2(e.target.value) }} placeholder="https://www.instagram.com/competidor2/" className="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
              </div>
              <div>
                ...
                <input type="text" value={url3} onChange={function(e) { setUrl3(e.target.value) }} placeholder="https://www.instagram.com/competidor3/" className="w-full border border-gray-300 rounded-lg px-4 py-3 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500" />
              </div>
