...
export const metadata: Metadata = {
  title: 'Benchmark CPL Chile 2026: Costo por Lead por Industria | Estudio M&P',
  description: 'Estudio completo de CPL (Costo por Lead), CAC, ROAS y tasas de conversión en Chile 2026. Datos reales de +200 campañas activas en Google Ads y Meta Ads por industria.',
  keywords: 'benchmark cpl chile, costo por lead chile, cpl por industria, benchmark google ads chile, benchmark meta ads chile, cac chile 2026, roas promedio chile',
  openGraph: {
    title: 'Benchmark CPL Chile 2026 | Estudio Muller y Pérez',
    description: 'CPL, CAC y ROAS por industria en Chile. Datos de +200 campañas reales.',
    url: 'https://www.mulleryperez.cl/benchmark-cpl-chile-2026',
    siteName: 'Müller & Pérez',
    locale: 'es_CL',
    type: 'article',
  },
  alternates: {
    canonical: 'https://www.mulleryperez.cl/benchmark-cpl-chile-2026',
  },
}

// Datos del benchmark - Actualizados Enero 2026
const benchmarkData = {
...
const studySchema = {
  ...
  '@type': 'Article',
  headline: 'Benchmark CPL Chile 2026: Costo por Lead por Industria',
  description: 'Estudio completo de CPL, CAC, ROAS y tasas de conversión en Chile 2026. Datos reales de +200 campañas activas.',
  author: {
    '@type': 'Organization',
    name: 'Muller y Pérez',
  ...
  mainEntityOfPage: 'https://www.mulleryperez.cl/benchmark-cpl-chile-2026',
}

const datasetSchema = {
  '@context': 'https://schema.org',
  '@type': 'Dataset',
  name: 'Benchmark CPL Chile 2026 por Industria',
  ...
  distribution: {
    '@type': 'DataDownload',
    contentUrl: 'https://www.mulleryperez.cl/benchmark-cpl-chile-2026',
...
export default function BenchmarkCPLChile2026() {
  return (
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2 text-center">
              CPL, CAC y ROAS por Industria en Chile 2026
            </h2>
            ...
            <p className="text-sm text-gray-500 mt-4 text-center">
              * CPL = Costo por Lead | CAC = Costo de Adquisición de Cliente | ROAS = Return on Ad Spend
              <br />
              Fuente: Data interna M&P, WordStream 2025, Triple Whale, Ubersuggest Chile
            </p>
          </div>
        </div>
      </section>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-green-600 mt-1 flex-shrink-0" />
                      CPCs calibrados con Ubersuggest Chile 2025
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-green-600 mt-1 flex-shrink-0" />
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white p-4 rounded-lg border border-gray-200 text-left">
              <code className="text-sm text-gray-700">
                Muller y Pérez. (2026). Benchmark CPL Chile 2026: Costo por Lead por Industria.
                Recuperado de https://www.mulleryperez.cl/benchmark-cpl-chile-2026
              </code>
            </div>
