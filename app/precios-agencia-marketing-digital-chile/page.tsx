  ...
  const faqSchema = createFAQPageSchema([
    {
      ...
      answer: 'Las agencias de marketing digital en Chile cobran entre $300.000 y $5.000.000 mensuales dependiendo del nivel de servicio. Agencias básicas: $300k-$500k, agencias profesionales como M&P: $950k-$2.5M, agencias premium: $3M-$5M+. El precio no incluye el presupuesto publicitario que se paga directo a Google/Meta.'
    },
    {
    ...
    },
    {
      ...
      answer: 'Muller y Pérez ofrece 3 planes: Silver ($950.000/mes) ideal para PYMEs, Gold ($1.500.000/mes) para empresas en crecimiento, y Platinum ($2.500.000/mes) para empresas que escalan agresivamente. Todos incluyen equipo dedicado de 3 profesionales, acceso full a cuentas y reportería frecuente.'
    }
  ])
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="bg-gradient-to-b from-blue-50 to-blue-100 rounded-2xl p-6 border-2 border-blue-500 relative">
                ...
                <p className="text-4xl font-bold text-center text-blue-700 mb-2">$950k - $2.5M</p>
              ...
              {[
                {
                  ...
                  a: 'Las agencias cobran entre $300.000 y $5.000.000 mensuales. Agencias básicas: $300k-$500k, profesionales como M&P: $950k-$2.5M, premium: $3M-$5M+. Esto NO incluye el presupuesto publicitario.'
                },
                {
