...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'article',
    url: 'https://www.mulleryperez.cl/investigacion/estudio-performance-marketing-chile-2026',
  ...
  '@graph': [
    {
      ...
      mainEntityOfPage: 'https://www.mulleryperez.cl/investigacion/estudio-performance-marketing-chile-2026',
      ...
      <footer className="bg-gray-900 text-white py-12 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-sm">
            ...
            <Link href="/investigacion" className="text-blue-400 hover:text-blue-300">← Volver al Blog</Link>
          </p>
        </div>
      </footer>
    </div>
