...
export default function AgenciaMarketingDigitalSantiagoPage() {
  ...
  const faqSchema = createFAQPageSchema([
    ...
    },
    {
      ...
      answer: 'El costo de una agencia de marketing digital en Santiago varía entre $950.000 y $2.500.000 mensuales. En M&P ofrecemos planes transparentes: Silver ($950k), Gold ($1.500.000) y Platinum ($2.5M), todos con equipo dedicado de 3 profesionales, acceso full a cuentas, reportería semanal y reuniones presenciales en nuestra oficina de Las Condes.'
    },
    {
          ...
          <section className="mb-16 bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-8">
            ...
            <div className="bg-white rounded-xl p-6 mb-6 shadow-sm">
              ...
              <ul className="space-y-3 text-gray-700">
                ...
                <li className="flex items-start">
                  <span className="text-2xl mr-3">💎</span>
                  <div>
                    <strong>Agencias premium con oficinas en Las Condes (M&P):</strong> $950k - $2.5M/mes<br />
            ...
            <div className="bg-green-50 border-l-4 border-green-500 p-6 rounded-lg mb-6">
              ...
              <ul className="space-y-2 text-gray-800">
                ...
                <li><strong>Plan Gold:</strong> $1.500.000/mes - Más popular, para empresas en crecimiento en la RM</li>
                <li><strong>Plan Platinum:</strong> $2.500.000/mes - Para empresas que escalan agresivamente en Santiago</li>
              </ul>
            ...
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  a: 'El costo de una agencia de marketing digital en Santiago varía entre $950.000 y $2.500.000 mensuales. En M&P ofrecemos planes transparentes: Silver ($950k), Gold ($1.500.000) y Platinum ($2.5M), todos con equipo dedicado de 3 profesionales, acceso full a cuentas, reportería semanal y reuniones presenciales en nuestra oficina de Las Condes.'
                },
                {
