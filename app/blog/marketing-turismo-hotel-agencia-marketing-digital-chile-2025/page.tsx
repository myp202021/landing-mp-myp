...
export const metadata: Metadata = {
  ...
  keywords: 'agencia de marketing digital, Turismo & Hotelería, marketing digital Chile 2025',
  alternates: {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-cyan-50/30 to-white">
      ...
      <article className="pt-32 pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            <span className="px-4 py-2 bg-cyan-100 text-cyan-700 rounded-full text-sm font-bold">Turismo & Hotelería</span>
          ...
          <p className="text-xl text-gray-600 mb-12 leading-relaxed">
            En Chile 2025, una agencia de marketing digital especializada transforma Turismo & Hotelería en resultados medibles con estrategias basadas en datos y performance real.
          </p>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-cyan-50 border-l-4 border-cyan-600 p-6 rounded-r-xl mb-12">
              ...
              <p className="text-gray-700">
                Contenido estratégico sobre Turismo & Hotelería en Chile 2025, incluyendo costos reales, estrategias comprobadas, casos de éxito locales y reportería financiera clara.
              </p>
            </div>
            ...
            <p className="text-gray-700 mb-6">
              En 2025, Turismo & Hotelería en Chile requiere una agencia de marketing digital que combine estrategia, datos y tecnología para generar resultados medibles y escalables.
            </p>

            <div className="bg-gradient-to-br from-cyan-600 to-purple-700 rounded-2xl p-10 text-center mt-16">
              <h3 className="text-3xl font-black text-white mb-4">
                ¿Quieres optimizar tu Turismo & Hotelería?
              </h3>
