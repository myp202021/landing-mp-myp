...
export const metadata: Metadata = {
  ...
  keywords: 'agencia de marketing digital, TikTok Ads, marketing digital Chile 2025',
  alternates: {
    canonical: 'https://www.mulleryperez.cl/blog/tiktok-ads-agencia-marketing-digital-chile-2025-2'
  },
  openGraph: {
    title: 'TikTok Ads en Chile 2025: Cómo una Agencia de Marketing Digital Convierte Awareness en Ventas',
    description: 'Descubre cómo una agencia de marketing digital en Chile 2025 usa TikTok Ads para convertir awareness en ventas, con benchmarks locales y casos reales.',
    type: 'article',
    url: 'https://www.mulleryperez.cl/blog/tiktok-ads-agencia-marketing-digital-chile-2025-2',
      ...
      <article className="pt-32 pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-12 leading-relaxed">
            En Chile 2025, una agencia de marketing digital especializada transforma TikTok Ads en resultados medibles con estrategias basadas en datos y performance real.
          </p>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-pink-50 border-l-4 border-pink-600 p-6 rounded-r-xl mb-12">
              ...
              <p className="text-gray-700">
                Contenido estratégico sobre TikTok Ads en Chile 2025, incluyendo costos reales, estrategias comprobadas, casos de éxito locales y reportería financiera clara.
              </p>
            </div>
            ...
            <p className="text-gray-700 mb-6">
              En 2025, TikTok Ads en Chile requiere una agencia de marketing digital que combine estrategia, datos y tecnología para generar resultados medibles y escalables.
            </p>

            <div className="bg-gradient-to-br from-pink-600 to-purple-700 rounded-2xl p-10 text-center mt-16">
              <h3 className="text-3xl font-black text-white mb-4">
                ¿Quieres optimizar tu TikTok Ads?
              </h3>
