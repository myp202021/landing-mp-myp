...
export const metadata: Metadata = {
  ...
  keywords: 'agencia de marketing digital, Agroindustria, marketing digital Chile 2025',
  alternates: {
      ...
      <article className="pt-32 pb-24 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 mb-12 leading-relaxed">
            En Chile 2025, una agencia de marketing digital especializada transforma Agroindustria en resultados medibles con estrategias basadas en datos y performance real.
          </p>
          ...
          <div className="prose prose-lg max-w-none">
            <div className="bg-green-50 border-l-4 border-green-600 p-6 rounded-r-xl mb-12">
              ...
              <p className="text-gray-700">
                Contenido estratégico sobre Agroindustria en Chile 2025, incluyendo costos reales, estrategias comprobadas, casos de éxito locales y reportería financiera clara.
              </p>
            </div>
            ...
            <p className="text-gray-700 mb-6">
              En 2025, Agroindustria en Chile requiere una agencia de marketing digital que combine estrategia, datos y tecnología para generar resultados medibles y escalables.
            </p>

            <div className="bg-gradient-to-br from-green-600 to-purple-700 rounded-2xl p-10 text-center mt-16">
              <h3 className="text-3xl font-black text-white mb-4">
                ¿Quieres optimizar tu Agroindustria?
              </h3>
