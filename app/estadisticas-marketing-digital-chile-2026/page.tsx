/**
 * Página GEO: Estadísticas Marketing Digital Chile 2026
...
export const metadata: Metadata = createMetadata({
  title: 'Estadísticas Marketing Digital Chile 2026 | Datos y Tendencias',
  description: 'Estadísticas actualizadas del marketing digital en Chile 2026. Inversión publicitaria, costos por lead, benchmarks por industria, tendencias y proyecciones.',
  keywords: [
    'estadisticas marketing digital chile',
    'datos marketing digital chile 2026',
    'inversion publicitaria chile',
    'costo por lead chile',
    'benchmark marketing digital',
    'tendencias marketing digital chile'
  ],
  path: '/estadisticas-marketing-digital-chile-2026'
})

export default function EstadisticasMarketingChilePage() {
  const webPageSchema = createWebPageSchema(
    'Estadísticas Marketing Digital Chile 2026',
    ...
    'https://www.mulleryperez.cl/estadisticas-marketing-digital-chile-2026'
  )

  const breadcrumbSchema = createBreadcrumbSchema([
    { name: 'Inicio', url: 'https://www.mulleryperez.cl' },
    { name: 'Estadísticas Marketing Digital Chile 2026', url: 'https://www.mulleryperez.cl/estadisticas-marketing-digital-chile-2026' }
  ])
      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="bg-gradient-to-b from-green-900 via-green-800 to-green-900 text-white py-20">
          <div className="container mx-auto px-6 max-w-5xl">
            <nav className="mb-8 text-sm" aria-label="Breadcrumb">
              ...
              <span className="text-white font-semibold">Estadísticas Marketing Digital Chile 2026</span>
            </nav>
            ...
            <p className="text-green-300 text-sm">
              Fuentes: IAB Chile, Google, Meta, datos propios de M&P | Actualizado: Enero 2026
            </p>
          </div>
        </section>
        ...
        <article className="container mx-auto px-6 max-w-5xl py-16">
          ...
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Inversión Publicitaria Digital en Chile 2026
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              <div className="bg-blue-50 rounded-2xl p-8 text-center">
                ...
                <p className="text-sm text-gray-500 mt-2">Inversión total Chile 2025</p>
              </div>
              <div className="bg-green-50 rounded-2xl p-8 text-center">
                <p className="text-5xl font-bold text-green-600 mb-2">+18%</p>
                <p className="text-gray-700 font-medium">Crecimiento vs 2024</p>
                <p className="text-sm text-gray-500 mt-2">Proyección 2026: +15%</p>
              </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="font-bold text-gray-900 mb-4">Distribución por Plataforma (Chile 2025)</h3>
          ...
          <section className="mb-16 bg-blue-50 rounded-2xl p-8">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">
              Benchmarks de Marketing Digital Chile 2026
            </h2>
        ...
        <footer className="bg-gray-900 text-white py-12">
          <div className="container mx-auto px-6 text-center">
            <p className="text-gray-400 mb-2">© 2026 Muller y Pérez | Estadísticas Marketing Digital Chile</p>
