...
export default function ComparadorWeb() {
  ...
  const comparadorSchema = createSoftwareAppSchema(
    ...
    'https://www.mulleryperez.cl/utilidades/comparador-web'
  )

  const breadcrumbSchema = createBreadcrumbSchema([
    { name: 'Inicio', url: 'https://www.mulleryperez.cl' },
    { name: 'Utilidades', url: 'https://www.mulleryperez.cl/utilidades' },
    { name: 'Comparador Web', url: 'https://www.mulleryperez.cl/utilidades/comparador-web' }
  ])
    ...
    <>
      ...
      <header className="border-b border-white/10 backdrop-blur-xl bg-white/5">
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <Link href="/utilidades" className="text-white font-semibold text-sm hover:text-blue-300 transition-colors">
            ← Volver
          </Link>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 mb-4 px-4 py-2 rounded-full bg-blue-500/10 border border-blue-400/20 backdrop-blur-sm">
            <Gauge className="w-4 h-4 text-blue-400" />
            <span className="text-blue-200 text-sm font-semibold">Análisis en Tiempo Real</span>
          </div>
