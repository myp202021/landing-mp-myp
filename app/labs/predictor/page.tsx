...
export default function PredictorLanding() {
  useEffect(() => {
    ...
    const imageUrl = 'https://agencia.mulleryperez.cl/og-predictor.svg'
      ...
      <header className="bg-white/80 backdrop-blur-lg border-b border-gray-200 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src="/logo-mp.png" alt="Muller y Pérez" className="h-10" />
            <div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4">
                <img src="/logo-mp.png" alt="Muller y Pérez" className="h-8" />
