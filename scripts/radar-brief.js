...
async function generarBrief(suscriptor, posts, supabase, memoria) {
  ...
  var prompt = 'Eres un DIRECTOR DE ESTRATEGIA DE CONTENIDOS con 15 anos de experiencia en marketing digital en Chile y Latinoamerica.\n'
    ...
    + '      "plataforma_principal": "Instagram|LinkedIn|ambas",\n'
    + '      "formatos_recomendados": ["reel", "carrusel", "articulo"],\n'
    + '      "frecuencia_sugerida": "2 por semana",\n'
    + '      "ejemplo_angulo_ig": "angulo si es para Instagram (visual, cercano, hook corto)",\n'
    + '      "ejemplo_angulo_li": "angulo si es para LinkedIn (datos, B2B, thought leadership)"\n'
    + '    }\n'
    + '  ],\n'
    + '  "tono_comunicacion": {\n'
    ...
    + '8. CADA territorio DEBE especificar plataforma_principal (Instagram, LinkedIn, o ambas)\n'
    + '9. Si el cliente tiene presencia en IG Y LinkedIn: MINIMO 2 territorios para LinkedIn (B2B, datos, thought leadership) y 2 para Instagram (visual, cercano, hooks)\n'
    + '10. Los ejemplos de angulo DEBEN ser diferentes para IG (visual, corto, emotivo) vs LinkedIn (profesional, datos, reflexion)\n'
