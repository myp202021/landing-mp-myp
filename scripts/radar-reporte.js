...
async function generarReporte(contexto, supabase, suscripcionId) {
  ...
  var prompt = 'Eres el DIRECTOR DE ESTRATEGIA de una agencia de performance marketing en Chile. '
    ...
    + '  "score_general": 0-100,\n'
    + '  "hallazgos_clave": [\n'
    + '    { "tipo": "positivo|negativo|neutro", "hallazgo": "Descripción concreta", "fuente": "qué agente lo detectó", "plataforma": "instagram|linkedin|ambas|general", "impacto": "alto|medio|bajo" }\n'
    + '  ],\n'
    + '  "acciones_inteligentes": [\n'
    + '    {\n'
    + '      "prioridad": 1,\n'
    + '      "area": "competencia|contenido|paid|organico|comercial",\n'
    + '      "plataforma": "instagram|linkedin|ambas|general",\n'
    ...
    + '- CADA hallazgo y acción DEBE indicar plataforma (instagram, linkedin, ambas, o general)\n'
    + '- Si hay datos de IG Y LinkedIn: OBLIGATORIO hallazgos SEPARADOS por red (no mezclar métricas IG con LI)\n'
