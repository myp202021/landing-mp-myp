...
function construirPrompt(perfil, metricasCompetidores, metricasCliente, tendencias, contentGaps, brief, memoria, industria, postsTop, contenidoGenerado) {
  ...
  p += '  },\n\n'
  p += '  "plan_campana": {\n'
  p += '    "objetivo_mes": "el objetivo principal del proximo mes basado en el analisis",\n'
  p += '    "canales": [\n'
  p += '      {\n'
  p += '        "canal": "Instagram|LinkedIn|Facebook|Google",\n'
  p += '        "rol": "para que se usa este canal en el mix",\n'
  p += '        "budget_pct": 30,\n'
  p += '        "formatos_recomendados": ["Reel", "Carrusel"],\n'
  p += '        "frecuencia_semanal": 3,\n'
  p += '        "engagement_estimado": "rango esperado basado en competencia"\n'
  p += '      }\n'
  p += '    ],\n'
  p += '    "temas_mes": [\n'
  p += '      {\n'
