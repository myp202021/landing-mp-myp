...
const COMPETIDORES = [
  ...
  { nombre: 'Espacio T',           instagram: null,                  linkedin: 'https://www.linkedin.com/company/espaciot/',         facebook: null,                                                                         web: null },
]
...
async function enviarEmail({ hoy, postsIG, competidoresConPost, sinActividad, postsLinkedin, postsFacebook, storiesIG }) {
  ...
  const payload = {
    ...
    to: TEST_MODE ? [TEST_EMAIL] : ['felipe.munoz@buseshualpen.cl', 'christopher@mulleryperez.cl'],
