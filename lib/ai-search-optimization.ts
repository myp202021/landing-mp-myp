...
export const AI_SEARCH_DATA: AISearchMetadata = {
  ...
  pricing: {
    ...
    max: 2500000,
    currency: 'CLP',
    model: 'Fee mensual + inversión publicitaria (presupuesto cliente). Planes: Silver ($950.000), Gold ($1.500.000), Platinum ($2.500.000). Todos + IVA. Sin contratos de permanencia.'
  },
