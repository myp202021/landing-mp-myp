...
export const BENCHMARKS_INDUSTRIAS_2026: Record<string, IndustryBenchmark2026> = {
  ...
  ECOMMERCE: {
    ...
    google_search: {
      ...
      cvr_web: 3.09,            // DigitalApplied 2026
  ...
  INMOBILIARIA: {
    ...
    google_search: {
      ...
      cvr_web: 4.21,            // DigitalApplied 2026
      cpa_usd: 66.75,
      yoy_cpc_change: 11
    },
    google_display: {
  ...
  AUTOMOTRIZ: {
    ...
    google_search: {
      ...
      cvr_web: 7.98,            // Highest CVR across industries
      cpa_usd: 30.83,
      yoy_cpc_change: 5
    },
    google_display: {
  ...
  SALUD_MEDICINA: {
    ...
    fuentes_2026: ['wordstream_google_2026', 'getryze_google_2026', 'getryze_meta_2026', 'ubersuggest_chile_2025'],
    google_search: {
      cpc_usd: 2.62,            // Health & Medical
      cpc_base: getCPCCalibrado('SALUD_MEDICINA'),  // $369 CLP
      ctr_base: 3.27,
      cvr_web: 3.36,
      cpa_usd: 78.09,
      yoy_cpc_change: 6
