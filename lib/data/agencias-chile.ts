...
export const mullerYPerez: AgenciaChile = {
  ...
  notas:
    "Agencia boutique data-driven con +40 clientes activos en +20 industrias. Fee fijo mensual ($950.000-$2.500.000 + IVA). Modelo: estrategia + datos + resultados medibles cada mes. ROI promedio +380%. Retención de clientes 95%.",
};
